...
const UserMeetingCard = ({ele , activeChip , cancelAppointMent}) => {
            ...
            <View style={styles.cardContainer}>
                <View style={styles.header}>
                    ...
                    <View style={styles.headerText}>
                        <Text style={styles.name}>{ele?.lawyer?.userName}</Text>
                        {/* <Text style={styles.experience}>{ele?.medium}</Text> */}
                        {/* <Text style={styles.experience}> pending</Text> */}
                        <Text style={styles.experience}>
                            <Icon name="map-marker" size={20} color="#151E70" /> {ele?.lawyer?.city}
                        </Text>
                    </View>
                </View>
                ...
                <View style={styles.details}>
                    ...
                    <View style={styles.detailColumn}>
                        ...
                        <Text style={styles.detailItem}>{ele?.lawyer?.email}</Text>
                    </View>
                </View>
                <View style={styles.details}>
                    <View style={styles.detailColumn}>
                ...
                </View> 
                {
                    activeChip === 'pending' ? (
                        <>
                        <Pressable style={{backgroundColor : '#8a120a',alignItems : 'center', padding : 10, marginTop : 5,borderRadius : 10}} onPress={()=>cancelAppointMent({_id :ele?._id})}>
                        <Text style={{fontFamily : 'Inter-Bold',color : "#FFFF",fontSize :20}}>Cancel Meeting</Text>
                </Pressable>
                        </>
                    ) : (
                        ('')
